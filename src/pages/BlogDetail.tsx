...
const data: Record<string, BlogPost> = {
  "kinh-nghiem-di-da-nang-tu-quang-tri": {
    ...
    description:
      "Chia sẻ kinh nghiệm đi Đà Nẵng từ Quảng Trị, lựa chọn xe ghép Quảng Trị hoặc xe dịch vụ Quảng Trị phù hợp, tiết kiệm và thuận tiện.",
    image:
...
👉 Đồng hành cùng du lịch Tân Oanh trong hành trình miền Trung`,
  ...
  "gia-xe-quang-tri-di-hue": {
    ...
    description:
      "Cập nhật thông tin tham khảo về giá xe Quảng Trị đi Huế, xe ghép Quảng Trị và xe dịch vụ Quảng Trị cho khách lẻ, gia đình và nhóm bạn.",
    image:
...
👉 Du lịch Tân Oanh hỗ trợ lịch trình linh hoạt`,
  ...
  "nen-di-xe-ghep-hay-thue-xe": {
    ...
    description:
      "So sánh ưu nhược điểm giữa xe ghép Quảng Trị và xe dịch vụ Quảng Trị để bạn chọn phương án phù hợp với ngân sách và lịch trình.",
    image:
...
👉 Du lịch Tân Oanh đồng hành cùng mọi chuyến đi`,
  ...
  "lich-trinh-du-lich-quang-tri-1-ngay": {
    ...
    description:
      "Gợi ý lịch trình du lịch Quảng Trị 1 ngày với Thành cổ Quảng Trị, Địa đạo Vịnh Mốc, Cầu Hiền Lương và các lựa chọn xe dịch vụ Quảng Trị phù hợp.",
    image:
...
👉 Du lịch Tân Oanh giúp bạn tối ưu chuyến đi`,
  ...
  "cach-dat-xe-ghep-quang-tri": {
    ...
    description:
      "Hướng dẫn cách đặt xe ghép Quảng Trị nhanh qua hotline, Zalo và những lưu ý để chuyến đi thuận tiện, tiết kiệm hơn.",
    image:
...
👉 Du lịch Tân Oanh hỗ trợ linh hoạt mọi lịch trình`,
  ...
  "top-dia-diem-du-lich-quang-tri": {
    ...
    description:
      "Tổng hợp top địa điểm du lịch Quảng Trị nổi bật như Thành cổ Quảng Trị, Địa đạo Vịnh Mốc, Cầu Hiền Lương và gợi ý xe ghép Quảng Trị phù hợp.",
    image:
...
const BlogDetail = () => {
  ...
  useEffect(() => {
    ...
    document.title = `${post.title} | Du lịch Tân Oanh`;
    ...
    canonical.setAttribute(
      "href",
      `https://dulichtanoanh.com/blog/${slug}`
    );

    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) {
      ogTitle.setAttribute("content", `${post.title} | Du lịch Tân Oanh`);
    }
    ...
    if (ogUrl) {
      ogUrl.setAttribute("content", `https://dulichtanoanh.com/blog/${slug}`);
    }
  }, [post, slug]);
